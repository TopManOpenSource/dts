...
public class DtsServerMessageHandlerImpl implements DtsServerMessageHandler {
    ...
    public void init() {
        clientHandler =
            ClientMessageHandler.createClientMessageProcessor(dtsLogDao, serverMessageSender, hazelcatInstance);
        rmHandler = RmMessageHandler.createResourceManagerMessageProcessor(dtsLogDao, serverMessageSender);
    }
    ...
    @Override
    public void handleMessage(String clientIp, RegisterMessage registerMessage, RegisterResultMessage resultMessage) {
