...
public abstract class AbstractExecutor {
    ...
    public <T> T executeStatement(final StatementModel statementUnit, final ExecuteCallback<T> executeCallback)
        throws Exception {
        return execute(statementUnit, Collections.emptyList(), executeCallback);
    }

    public <T> T executePreparedStatement(final StatementModel preparedStatementUnits, final List<Object> parameters,
    ...
    private <T> T executeInternal(final StatementModel baseStatementUnit, final List<Object> parameterSet,
        final ExecuteCallback<T> executeCallback) throws Exception {
        try {
